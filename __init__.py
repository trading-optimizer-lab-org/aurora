...
try:
    __version__ = _pkg_version("quantforge")
...
try:
    from quantforge.core.engine import run_backtest  # noqa: F401
    from quantforge.core.seed import set_global_seed  # noqa: F401
    from quantforge.core.costs import IBKR_costs  # noqa: F401
...
try:
    from quantforge.core.engine_multi import MultiAssetEngine  # noqa: F401
    __all__.append("MultiAssetEngine")
except ImportError:  # pragma: no cover
    pass

try:
    from quantforge.validation.pipeline import validate_pipeline  # noqa: F401
