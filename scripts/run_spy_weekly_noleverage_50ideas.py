...
IDEA_SPECS: list[dict[str, Any]] = [
    {"idea_id": "weekly_failed_breakout_reversal", "idea_family": "price_action", "patterns": ["failed_breakout", "failed_breakdown", "close_location"]},
    {"idea_id": "weekly_inside_bar_expansion", "idea_family": "price_action", "patterns": ["inside_bar", "range_pct", "ret_1w"]},
    {"idea_id": "weekly_outside_bar_fade", "idea_family": "price_action", "patterns": ["outside_bar", "close_location", "range_pct"]},
    {"idea_id": "weekly_close_location_regime", "idea_family": "price_action", "patterns": ["close_location"]},
    {"idea_id": "weekly_range_compression_breakout", "idea_family": "price_action", "patterns": ["range_z", "range_pct", "ret_1w"]},
    {"idea_id": "weekly_range_expansion_exhaustion", "idea_family": "price_action", "patterns": ["range_z", "close_location", "ret_1w"]},
    {"idea_id": "weekly_gap_hold_through_week", "idea_family": "gap", "patterns": ["gap", "intraw_"]},
    {"idea_id": "weekly_gap_failure_reversal", "idea_family": "gap", "patterns": ["gap_failure", "gap", "close_location"]},
    {"idea_id": "weekly_two_week_reversal", "idea_family": "reversal", "patterns": ["ret_2w", "lower_wick", "upper_wick"]},
    {"idea_id": "weekly_three_week_continuation", "idea_family": "momentum", "patterns": ["ret_3w", "volatility", "range_z"]},
    {"idea_id": "weekly_volatility_contraction_trend", "idea_family": "volatility", "patterns": ["volatility_contraction", "ma_slope", "ret_13w"]},
    {"idea_id": "weekly_volatility_expansion_cash_filter", "idea_family": "volatility", "patterns": ["volatility_expansion", "volatility", "ret_4w"]},
    {"idea_id": "weekly_atr_channel_reclaim", "idea_family": "support_resistance", "patterns": ["atr_reclaim", "atr_channel"]},
    {"idea_id": "weekly_atr_stop_distance_filter", "idea_family": "risk_filter", "patterns": ["atr_stop_distance", "atr_pct"]},
    {"idea_id": "weekly_drawdown_recovery", "idea_family": "drawdown", "patterns": ["drawdown", "ret_1w"]},
    {"idea_id": "weekly_drawdown_acceleration_short", "idea_family": "drawdown", "patterns": ["drawdown_accel", "drawdown"]},
    {"idea_id": "weekly_pullback_in_uptrend", "idea_family": "trend_pullback", "patterns": ["pullback_uptrend", "ma_gap", "ma_slope"]},
    {"idea_id": "weekly_rally_in_downtrend_short", "idea_family": "trend_pullback", "patterns": ["rally_downtrend", "ma_gap", "ma_slope"]},
    {"idea_id": "weekly_ma_slope_cash_band", "idea_family": "trend", "patterns": ["ma_slope"]},
    {"idea_id": "weekly_dual_ma_distance_mean_revert", "idea_family": "mean_reversion", "patterns": ["dual_ma_distance", "ma_gap"]},
    {"idea_id": "weekly_ma_stack_persistence", "idea_family": "trend", "patterns": ["ma_stack", "ma_slope"]},
    {"idea_id": "weekly_rsi_regime_switch", "idea_family": "oscillator", "patterns": ["rsi"]},
    {"idea_id": "weekly_rsi_failure_swing", "idea_family": "oscillator", "patterns": ["rsi_failure", "rsi"]},
    {"idea_id": "weekly_macd_zero_line_filter", "idea_family": "oscillator", "patterns": ["macd_line", "macd_hist"]},
    {"idea_id": "weekly_macd_histogram_turn", "idea_family": "oscillator", "patterns": ["macd_hist_turn", "macd_hist"]},
    {"idea_id": "weekly_volume_climax_reversal", "idea_family": "volume", "patterns": ["volume_z", "close_location"]},
    {"idea_id": "weekly_volume_confirmed_breakout", "idea_family": "volume", "patterns": ["volume_z", "failed_breakout", "ret_1w"]},
    {"idea_id": "weekly_volume_dryup_pullback", "idea_family": "volume", "patterns": ["volume_dryup", "pullback_uptrend", "rally_downtrend"]},
    {"idea_id": "weekly_vix_spike_recovery", "idea_family": "vix", "patterns": ["vix_spike", "vix_chg", "ret_1w"]},
    {"idea_id": "weekly_vix_persistent_stress_short", "idea_family": "vix", "patterns": ["vix_level", "vix_persistent"]},
    {"idea_id": "weekly_vix_divergence", "idea_family": "vix", "patterns": ["vix_divergence", "vix_chg"]},
    {"idea_id": "weekly_vix_term_structure_risk_on_off", "idea_family": "vix_term", "patterns": ["vix_term", "vix_level"]},
    {"idea_id": "weekly_rates_shock_filter", "idea_family": "rates", "patterns": ["rates_shock", "tnx_chg"]},
    {"idea_id": "weekly_yield_curve_resteepening", "idea_family": "rates", "patterns": ["yield_curve", "curve_chg"]},
    {"idea_id": "weekly_dollar_stress_filter", "idea_family": "dollar", "patterns": ["dxy", "dollar_stress"]},
    {"idea_id": "weekly_credit_proxy_risk_filter", "idea_family": "credit", "patterns": ["credit", "hyg_lqd"]},
    {"idea_id": "weekly_tlt_spy_rotation", "idea_family": "relative_assets", "patterns": ["tlt_spy", "tlt_rel"]},
    {"idea_id": "weekly_sector_breadth_confirmation", "idea_family": "sector_breadth", "patterns": ["sector_breadth"]},
    {"idea_id": "weekly_defensive_sector_warning", "idea_family": "sector_rotation", "patterns": ["defensive", "sector"]},
    {"idea_id": "weekly_cyclical_sector_confirmation", "idea_family": "sector_rotation", "patterns": ["cyclical", "sector"]},
    {"idea_id": "weekly_smallcap_confirmation", "idea_family": "cross_asset", "patterns": ["iwm_rel", "smallcap"]},
    {"idea_id": "weekly_nasdaq_confirmation", "idea_family": "cross_asset", "patterns": ["qqq_rel", "nasdaq"]},
    {"idea_id": "weekly_dow_transport_like_proxy", "idea_family": "cross_asset", "patterns": ["dia_rel", "industrial"]},
    {"idea_id": "weekly_global_equity_confirmation", "idea_family": "global", "patterns": ["global_breadth"]},
    {"idea_id": "weekly_asia_leads_spy", "idea_family": "global", "patterns": ["asia_lead", "n225", "hsi"]},
    {"idea_id": "weekly_europe_leads_spy", "idea_family": "global", "patterns": ["europe_lead", "ftse", "dax"]},
    {"idea_id": "weekly_calendar_turn_month", "idea_family": "calendar", "patterns": ["calendar_turn_month"]},
    {"idea_id": "weekly_calendar_opex_like_cycle", "idea_family": "calendar", "patterns": ["calendar_opex"]},
    {"idea_id": "weekly_post_loss_week_behavior", "idea_family": "post_event", "patterns": ["post_loss", "ret_1w"]},
    {"idea_id": "weekly_post_gain_week_behavior", "idea_family": "post_event", "patterns": ["post_gain", "ret_1w"]},
]


def main() -> None:
    require_github_actions_or_explicit_local_permission("SPY weekly no-leverage 50 ideas nightly")
...
def run_shard(
    ...
    *,
    ...
    while evaluated < int(configs_per_stage) and time.monotonic() < deadline:
        ...
        rows.append(
            {
                "strategy_id": f"spy_weekly_noleverage_50ideas_s{stage:03d}_{digest}",
                "stage": int(stage),
