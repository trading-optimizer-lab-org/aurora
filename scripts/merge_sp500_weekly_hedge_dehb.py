...
def main() -> int:
    ...
    subperiods = pd.DataFrame() if args.lightweight else generate_subperiod_report(leaderboard)
    negative_years = pd.DataFrame() if args.lightweight else generate_negative_sp500_years_report(leaderboard)
