...
CAMPAIGN_ID = "paper_sharpe2_nightly_30min_until_0630"
TARGET_SHARPE = 2.0
...
ROUND_SPECS: list[dict[str, Any]] = [
    {"name": "operable_paper_ensemble", "engine": "ensemble", "configs": 1200},
    {"name": "spy_weekly_paper_rules", "engine": "generic", "prefixes": ["spy_mom_", "spy_ma_gap_", "spy_drawdown_"]},
    {"name": "spy_weekly_regime_simple", "engine": "generic", "prefixes": ["spy_mom_", "vix_", "total_pc_"]},
    {"name": "spy_weekly_regime_rich", "engine": "generic", "prefixes": ["spy_mom_", "spy_ma_gap_", "vix_", "total_pc_", "skew_", "yield_curve_"]},
    {"name": "cboe_put_call_sentiment", "engine": "cboe", "configs": 5_000_000},
    {"name": "vix_term_structure", "engine": "generic", "prefixes": ["vix_term_", "vixmo_", "vix_", "vrp_", "iv_rv_"]},
    {"name": "cboe_option_benchmark_timing", "engine": "generic", "prefixes": ["pput_", "bxy_", "bxmd_", "cmbo_", "puty_"]},
    {"name": "trend_following_crisis_alpha", "engine": "generic", "prefixes": ["spy_mom_", "spy_ma_gap_", "yield_curve_", "vix_"]},
    {"name": "defensive_etf_risk_parity_proxy", "engine": "generic", "prefixes": ["yield_curve_", "spy_realized_vol_", "vix_", "pput_", "bxy_"]},
    {"name": "yield_curve_stress", "engine": "generic", "prefixes": ["yield_curve_", "vix_", "spy_drawdown_"]},
    {"name": "credit_stress", "engine": "generic", "prefixes": ["credit_", "yield_curve_", "vix_", "spy_realized_vol_"]},
    {"name": "gold_commodity_safe_haven", "engine": "generic", "prefixes": ["gold_", "commodity_", "vix_", "spy_mom_"]},
    {"name": "dollar_fx_safe_haven", "engine": "generic", "prefixes": ["dollar_", "fx_", "yield_curve_", "vix_"]},
    {"name": "macro_recession_liquidity", "engine": "generic", "prefixes": ["macro_", "liquidity_", "yield_curve_", "vix_", "total_pc_"]},
    {"name": "train_only_paper_selector", "engine": "ensemble", "configs": 1800},
]
