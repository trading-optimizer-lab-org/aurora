...
from aurora.infra.sp500_megarun.predictive_feature_smoke import (
...
def main() -> int:
    require_github_only_execution(
        "SP500_MEGARUN_PREDICTIVE_FEATURE_SMOKE_F141_F150"
    )
    parser = argparse.ArgumentParser(
        description="Run train-only predictive feature smoke F141-F150."
    )
    ...
    report = build_predictive_feature_smoke(
        args.train_snapshot,
