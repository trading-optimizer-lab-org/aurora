...
def main() -> int:
    ...
    receipt = {"schema_version": 1, "strategy_count": len(ordered), "feasible_count": sum(bool(row["train_feasible"]) for row in summary_rows), "top_10": top, "validation_opened": False, "locked_opened": False}
