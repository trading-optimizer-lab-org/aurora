...
from aurora.infra.sp500_megarun.feature_smoke import (
...
def main() -> int:
    ...
    parameter_report = build_price_parameter_choice_audit(
        spy,
        ...
        output_path=args.output_dir / "parameter_choice_audit_F001_F020.json",
    )
    print(json.dumps(report, sort_keys=True))
    return (
        0
        if report["ready"]
        and report["executable_lane_count"] == 20
        and parameter_report["ready"]
        else 1
    )
