...
NEGATIVE_OUTPERFORM_RE = re.compile(
    ...
    r"no approach[^.]{0,120}beat[^.]{0,120}benchmark[^.]{0,120}(cost|costs|transaction)|"
    r"not beat[^.]{0,120}benchmark[^.]{0,120}(cost|costs|transaction)|"
...
OTHER_TRADED_ASSET_RE = re.compile(
    ...
    r"master limited partnerships?|mlps?|commodity futures|derivatives market|cot report|commitment of traders|"
