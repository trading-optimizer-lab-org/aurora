...
def main() -> int:
    require_github_only_execution("SP500_MEGARUN_MACRO_FEATURE_SMOKE_F032_F038")
    parser = argparse.ArgumentParser(
        description="Run the train-only technical feature smoke for F032-F038."
    )
    ...
    return 0 if report["ready"] and report["executable_lane_count"] == 7 else 1
