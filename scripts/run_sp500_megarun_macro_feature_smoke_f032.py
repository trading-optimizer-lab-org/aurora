...
def main() -> int:
    require_github_only_execution("SP500_MEGARUN_MACRO_FEATURE_SMOKE_F032_F050")
    parser = argparse.ArgumentParser(
        description="Run the train-only technical feature smoke for F032-F050."
    )
    ...
    return 0 if report["ready"] and report["executable_lane_count"] == 19 else 1
