...
try:
    from aurora.core.gtbi_feature_store import (
        FeatureStore,
        SignalPrimitiveStore as _AuthoritativeSignalPrimitiveStore,
        benchmark_cache_identity as _benchmark_cache_identity,
        build_feature_store as _build_authoritative_feature_store,
        exact_float_cache_token as _exact_float_cache_token,
        frame_content_identity as _frame_content_identity,
    )
except ModuleNotFoundError:  # Direct script execution before editable install refresh.
    from core.gtbi_feature_store import (
        FeatureStore,
        SignalPrimitiveStore as _AuthoritativeSignalPrimitiveStore,
        benchmark_cache_identity as _benchmark_cache_identity,
        build_feature_store as _build_authoritative_feature_store,
...
class SignalPrimitiveStore(_AuthoritativeSignalPrimitiveStore):
    """Compatibility adapter wired to the frozen GTBI scientific callbacks."""
    ...
    def __init__(self, frame: pd.DataFrame, benchmark_prices: pd.DataFrame) -> None:
        super().__init__(
            ...
            rsi_calculator=_rsi,
            market_trend_calculator=_market_trend_ok,
...
def build_feature_store(
    ...
    *,
    ...
    del prewarm  # Retained for CLI/API compatibility; the store remains lazy.
    return _build_authoritative_feature_store(
        symbol_frames,
        benchmark_prices,
        prepare_ohlcv=_prepare_ohlcv,
        rsi_calculator=_rsi,
