...
export function ArtifactsView({ page, onLoadMore, loadingMore = false }: { page: Page<Artifact> | null; onLoadMore?: () => void; loadingMore?: boolean }) {
  ...
  return <div className="section-page">
    <div className="section-heading">
      <div><span className="eyebrow">ARTIFACT INDEX</span><h1>Artefactos</h1><p>Todo lo que produce GitHub, con el estado de archivo real.{page?.total_count ? ` GitHub informa ${page.total_count.toLocaleString("es-ES")} artefactos.` : ""}</p></div>
