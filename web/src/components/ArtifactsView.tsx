...
export function ArtifactsView({ page }: { page: Page<Artifact> | null }) {
  ...
  return <div className="section-page">
    <div className="section-heading">
      <div><span className="eyebrow">ARTIFACT INDEX</span><h1>Artefactos</h1><p>Todo lo que produce GitHub, con el estado de archivo real.</p></div>
