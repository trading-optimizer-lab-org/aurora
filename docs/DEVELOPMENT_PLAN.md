# QuantForge Development Plan — v0.1 → v1.0
...
**File:** `quantforge/core/engine_multi.py`
...
**File:** `quantforge/core/engine_jit.py`
...
**File:** `quantforge/reporting/tearsheet.py`
...
**File:** `quantforge/core/logging.py`
...
**File:** `quantforge/core/config.py`
...
**File:** `quantforge/validation/walk_forward.py` (extend)
...
**File:** `quantforge/validation/noise_injection.py`
...
**File:** `quantforge/validation/gap_sim.py`
...
**File:** `quantforge/validation/retraining.py`
...
**File:** `quantforge/validation/pipeline.py` (extend)
...
**File:** `quantforge/deployment/sizing.py`
...
**File:** `quantforge/deployment/live.py`
...
**File:** `quantforge/core/data_layer.py` (extend)
...
**File:** `quantforge/core/features.py`
...
**File:** `quantforge/cli/forge.py` (extend)
