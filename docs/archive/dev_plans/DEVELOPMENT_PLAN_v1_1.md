# QuantForge v1.1 Development Plan
...
File: `quantforge/validation/purged_cv.py`
...
File: `quantforge/ml/feature_importance.py`
...
File: `quantforge/ml/fracdiff.py`
...
File: `quantforge/validation/structural_breaks.py`
...
File: `quantforge/validation/cscv_pbo.py`
...
File: `quantforge/deployment/hrp.py` (or extend allocator.py)
...
File: `quantforge/deployment/risk_optim.py`
...
File: `quantforge/deployment/black_litterman.py`
...
File: `quantforge/deployment/cov_shrinkage.py`
...
File: `quantforge/deployment/risk_parity.py`
...
File: `quantforge/analytics/metrics_full.py`
...
File: `quantforge/analytics/factor_analysis.py`
...
File: `quantforge/analytics/attribution.py`
...
File: `quantforge/analytics/round_trip.py`
...
File: `quantforge/core/slippage.py`
...
File: `quantforge/reporting/tearsheet.py` (extend)
