...
class CheckpointRecoveryOwnerProofV1:
    ...
    evidence_kind: Literal['failed_owner_without_terminal'] = 'failed_owner_without_terminal'
...
def verify_checkpoint_failure_owner(
    *, profile: CheckpointRecoveryProfileV1, owner: FastGateOwnerEvidence,
    ...
    """Validate the exact lost-finalizer state after production reader authentication.
    ...
    try:
        if (
            ...
            or owner.unlaunched_terminal or terminal is not None
