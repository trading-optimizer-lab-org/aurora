...
def _repair_macro_configuration(
    lane_id: str,
    parameter: str,
    configuration: dict[str, Any],
) -> dict[str, Any]:
    if lane_id == "F050" and parameter == "target_weekday":
        configuration["calendar_rule"] = "weekday"
    if lane_id == "F050" and parameter == "target_month":
        configuration["calendar_rule"] = "month"
...
def build_macro_feature_smoke(
    ...
    *,
    ...
    parameter_audit = audit_frozen_parameter_choices(
        ...
        evaluator=lambda lane_id, configuration: evaluate_macro_lane(
            lane_id, panels, configuration
        ),
        expected_years=expected_years,
        repair=_repair_macro_configuration,
    )
    ...
    (root / "parameter_choice_audit_F032_F050.json").write_text(
