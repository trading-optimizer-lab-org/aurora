...
PROTOCOL_COMMON_PATHS = (
    ...
    "infra/sp500_megarun/catalog_fast_path.py",
    ...
    "infra/sp500_megarun/catalog_prepared_bundle.py",
    ...
    "scripts/admit_catalog_fast_request.py",
    "scripts/capture_catalog_routing_snapshot.py",
    "scripts/control_catalog_run.py",
    "scripts/finalize_catalog_controller_run.py",
    "scripts/finalize_catalog_fast_run.py",
    "scripts/finalize_catalog_preparation.py",
    "scripts/inspect_catalog_fast_request.py",
    "scripts/inspect_catalog_preparation.py",
    "scripts/prepare_catalog_admission_candidates.py",
    "scripts/prepare_catalog_admission_decision.py",
    "scripts/prepare_catalog_campaign.py",
    ...
    "scripts/select_catalog_preparation_targets.py",
    "scripts/verify_catalog_authority_record.py",
    "scripts/verify_catalog_prepared_bundle.py",
    "scripts/verify_catalog_production_runtime.py",
