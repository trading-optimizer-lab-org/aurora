...
def generate_full_tearsheet(result, output_path: str,
                            title: str = "Aurora Full Tearsheet",
...
<h1>{safe_title}</h1>
<p class="muted">Generated by Aurora tearsheet.py (full)</p>
...
def generate_pdf(result, output_path: str, title: str = "Aurora Tearsheet",
                 benchmark_result=None) -> str:
