...
def test_atlas_generation_two_keeps_its_approved_historical_definition():
    ...
    ticket = CatalogLaunchTicketV1(
        ...
        campaign_definition_sha256="cdbd3fcfad1e3bc70d6f2fd6699015e0a06cb980aae027ea181261d1fff58367",
...
def test_atlas_generation_three_uses_only_the_closed_second_request_and_current_definition():
    from aurora.infra.sp500_megarun.catalog_campaign_definition_contract import parse_catalog_campaign_definition_bytes
    from aurora.infra.sp500_megarun.catalog_lineage_transition import load_lineage_transition
    ...
    ticket = CatalogLaunchTicketV1(
        schema_version="1", request_id="018f47a2-6e91-7c34-8000-000000000030",
        campaign_key="sp500-atlas-v1", launch_generation=3,
        previous_terminal_request_sha256="fac5dcb9359ebeded5b8d2fd06af4f8c332d4aace282dc6667fd446e80ae10d2",
